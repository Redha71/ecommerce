                          ...
                          <div class="cart_items">
                            ...
                            <ul class="list-group col-lg-8" style="float: right;">
                                ...
                                @endif
                                    ...
                                    <li class="list-group-item">Shiping Charge : <span style="float: right;">${{ $charge  }} </span>
                                    </li>
                                    <li class="list-group-item">Vat : <span style="float: right;">${{ $vat }} </span>
                                    </li>
                                @if(Session::has('coupon'))
                                    <li class="list-group-item">Total : <span style="float: right;">${{ Session::get('coupon')['balance'] + $charge + $vat }} </span>
                                    </li>
                                @else
                                    <li class="list-group-item">Total : <span style="float: right;">${{ Cart::Subtotal() + $charge + $vat }} </span>
                                    </li>
                                @endif
...
var stripe = Stripe('pk_test_51ITCzhIP2HkxHvJ6KidsvRlhpruW0sDlTrurEqaZpyl40FBxe9NWE9fppULGvKFNnTGeoFxZM0dkvmATw9r62Ixm00SBSaGwOj');
