...
class PaymentController extends Controller
{
    public function Payment(Request $request){
        ...
        $data['payment'] = $request->payment;
         ...
         return view('pages.payment.stripe',compact('data','setting','charge','vat','cart'));
       ...
       public function StripeCharge(Request $request){
             ...
             \Stripe\Stripe::setApiKey('sk_test_51ITCzhIP2HkxHvJ62FiHSggT7gcTHrxznsLh9OR7Q0Z2ZIACTk2yI5YlQR1rJQAVaOo5y34DACS0LMYuMksgMFZK003gI6Z5A6');
             ...
             $charge = \Stripe\Charge::create([
                 'amount' => $total*100,
                 'currency' => 'gbp',
                 'description' => 'Clearnce Ecommerce Details',
                 'source' => $token,
